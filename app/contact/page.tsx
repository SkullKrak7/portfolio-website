    ...
    <main className="min-h-screen py-20" style={{ background: 'var(--bg-page)' }}>
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 rounded-lg" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
          ...
          <div className="p-6 rounded-lg" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
            <h3 className="font-bold mb-2" style={{ color: 'var(--text-primary)' }}>LinkedIn</h3>
            <a href="https://linkedin.com/in/karthik-kagolanu" target="_blank" rel="noopener noreferrer" 
